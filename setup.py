...
setup(
    ...
    name="snweatherstation",  # Required
    ...
    description="Another Raspberry Pi Weatherstation",  # Optional
    ...
    url="https://github.com/signag/snweatherstation",  # Optional
    ...
    keywords="RaspberryPi weatherstation",  # Optional
